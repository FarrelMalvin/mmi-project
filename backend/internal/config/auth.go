...
func (s *JWTService) GenerateAccessToken(ctx context.Context, userID uint, jabatan string, nama string) (string, error) {
...
func (s *JWTService) GenerateTokenPair(ctx context.Context, userID uint, jabatan string, name string) (*TokenPair, error) {
	accessToken, err := s.GenerateAccessToken(ctx, userID, jabatan, name)
	if err != nil {
		return nil, err
	}
...
func (s *JWTService) RefreshTokens(ctx context.Context, refreshTokenString string, jabatan string, nama string) (*TokenPair, error) {
	...
	return s.GenerateTokenPair(ctx, claims.UserID, jabatan, nama)
}
